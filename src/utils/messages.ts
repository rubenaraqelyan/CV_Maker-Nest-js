export default {
  ...
  PASSWORD_VALIDATION_ERROR: 'Passwords will contain at least 8 or more characters, 1 upper case letter, 1 lower case letter, 1 number and 1 special character'
}