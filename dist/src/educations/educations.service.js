...
let EducationsService = class EducationsService {
    ...
    async getById(user_id, id) {
        ...
        if (!data)
            throw new common_1.HttpException('Education not found', common_1.HttpStatus.NOT_FOUND);
        return data;
    }
...
EducationsService = __decorate([
    ...
    __param(0, (0, inject_model_sql_1.InjectSqlModel)(educations_model_1.educations)),
