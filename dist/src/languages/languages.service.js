...
const languages_model_1 = require("./languages.model");
let LanguagesService = class LanguagesService {
    ...
    async getById(user_id, id) {
        ...
        if (!data)
            throw new common_1.HttpException('Language not found', common_1.HttpStatus.NOT_FOUND);
        return data;
    }
...
LanguagesService = __decorate([
    ...
    __param(0, (0, inject_model_sql_1.InjectSqlModel)(languages_model_1.languages)),
